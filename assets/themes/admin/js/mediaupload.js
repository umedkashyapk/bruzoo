define('elFinderConfig', {
            ...
            $(document).on('click','#elfinder_button', function() {
              ...
              $('<div id="editor" />').dialogelfinder({
                ...
                {
                    console.log(file);
                    var filePath = BASE_URL+"media/"+file.path; //file contains the relative url.
                    var imgPath = "<img class='img-thumbnail ifile_img_thumb' src = '"+filePath+"'/>";
                    $('.ifile_img_filed').val(file.path); //name of selected images
                    $('.ifile_img_filed').text(file.name); //name of selected images
                    $('#selectedImages').html(imgPath); //add the image to a div so you can see the selected images
