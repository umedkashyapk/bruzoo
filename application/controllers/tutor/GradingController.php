...
class GradingController extends Tutor_Controller 
{
    ...
    function index() 
    {
        ...
        $data = $this->includes;    
        $content_data = array();
        $data['content'] = $this->load->view('tutor/grading/list', $content_data, TRUE);
    ...
    function add() 
    {
        ...
        else 
        {
            ...
            redirect(base_url('tutor/quiz-grading'));
        }
        ...
        $data['content'] = $this->load->view('tutor/grading/form', $content_data, TRUE);
        $this->load->view($this->template, $data);
    }
    ...
    function ajax_list() 
    {
        ...
        foreach ($list as $db_data) {
            ...
            $button = '<a href="' . base_url("tutor/quiz-grading-update/". $db_data->id) . '" data-toggle="tooltip"  title="'.lang("admin_edit_record").'" class="btn btn-primary btn-action mr-1"><i class="fas fa-pencil-alt"></i></a>';            
            $button.= '<a href="' . base_url("tutor/quiz-grading-delete/" . $db_data->id) . '" data-toggle="tooltip"  title="'.lang("admin_delete_record").'" class="btn btn-danger btn-action mr-1 common_delete"><i class="fas fa-trash"></i></a>';
