...
class Study_Material extends Admin_Controller {
    ...
    { 
        ...
        else
        {
            if($this->settings->file_uploader == 'media manager')
            {
                ...
                $media_file = str_replace("media/","",$media_file);
                $media_file = base_url($media_file_path);
            }
            else
            {
                ...
                {   
                    ...
                    $path2 = "assets/images/studymaterial";
                    ...
                    if($material_file_upload['status'] == 'success')
                    {
                        ...
                        $media_file = base_url($path2.'/'.$upload_file_name);
                    }
                    else
                    {
            ...
            $study_material_content['media_file'] =  $media_file;
    ...
    function add_material_file($study_material_id = NULL,$contant_type)
    {
        ...
        if($this->input->post('title'))
        {
            ...
            $media_file_path = $media_file;
            $media_file = str_replace("media/","",$media_file);
            $media_file2 = base_url($media_file_path);
            ...
            if($contant_type == "image" OR $contant_type == "audio" OR $contant_type == "video" OR $contant_type == "pdf" OR $contant_type == "doc" )
            {
                ...
                elseif($this->settings->file_uploader == 'media manager')
                {
            ...
            else
            {
                ...
                if($this->settings->file_uploader == 'media manager' && empty($embed_code_contant) && empty($media_file))
                {
                    $this->session->set_flashdata('error', lang('something_went_wrong')); 
                    redirect(base_url('admin/study/material-file/'.$study_material_id));
                }
                ...
                else
                {
                    ...
                    {   
                        ...
                        $path2 = "assets/uploads/study_material";
                        ...
                        {
                            $upload_file_name = $material_file_upload['upload_data']['file_name'];
                            $value = base_url($path2.'/'.$upload_file_name);
