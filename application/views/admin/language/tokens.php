      ...
      <div class="card">
         <div class="card-body">
            <div class="row">
               ...
               ?> 
                  <div class="col-12">
                     <h6 class="text-danger">Note: <?php echo lang('you_can_save_active_tab_data_at_a_time'); ?></h6>
                     <nav>
                        <ul class="nav nav-tabs" id="nav-tab" role="tablist">
                           <li data-value="admin"><a class="nav-item nav-link active" id="nav-admin-token-tab" data-value="admin" data-toggle="tab" href="#nav-admin-token" role="tab" aria-controls="nav-admin-token" aria-selected="true"><?php echo lang('admin_lang_token'); ?></a></li>
                           <li><a class="nav-item nav-link" id="nav-front-token-tab" data-value="front" data-toggle="tab" href="#nav-front-token" role="tab" aria-controls="nav-front-token" aria-selected="false"><?php echo lang('front_lang_token'); ?></a></li>
                           <li><a class="nav-item nav-link" id="nav-other-token-tab" data-value="other" data-toggle="tab" href="#nav-other-token" role="tab" aria-controls="nav-other-token" aria-selected="false"><?php echo lang('other_lang_token'); ?></a></li>
                        </ul>
                     </nav>
                  </div>
