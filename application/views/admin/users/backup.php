            ...
            foreach ($backups_array as  $backup_file_name) 
            {
               ...
               <tr>
                  ...
                  <td>
                     ...
                     <a href="<?php echo base_url('admin/users/remove_backup/').$backup_file_name; ?>" data-toggle="tooltip"  title="<?php echo lang("admin_delete_record"); ?>" class="btn btn-danger btn-action mr-1 common_delete">
                        <i class="fas fa-trash"></i>
                     </a>

                     <a href="<?php echo base_url('admin/users/download_backup/').$backup_file_name; ?>" data-toggle="tooltip"  title="<?php echo lang("download"); ?>" class="btn btn-info btn-action mr-1">
