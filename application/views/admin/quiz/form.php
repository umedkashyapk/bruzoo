    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="row mt-3">
          ...
          <div class="col-3">
            <div class="form-group <?php echo form_error('exam_type') ? ' has-error' : ''; ?>">
              <?php echo  form_label('Exam Type', 'exam_type'); ?>

              <span class="required">*</span>
             <select name="exam_type" id="exam_type" class="form-control select_dropdown" >
