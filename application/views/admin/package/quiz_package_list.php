...
<div class="panel panel-default">
   <a href="<?php echo base_url('admin/package/add_package_quiz');?>" class="btn btn-primary cat float-right" ><?php echo lang('admin_add_quiz_package'); ?></a>
   ...
   <table id="table" class="display table table-striped table-bordered" cellspacing="0" width="100%">
      <thead>
         <tr>
            ...
            <th><?php echo lang('quiz_price'); ?></th>
