      ...
      <div class="row">
         <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="card card-primary">
               ...
               <div class="card-body">
                  <p class="text-muted">We will send a link to Your Email Address For Activate Your Account</p>
                  <?php echo form_open('', array('class'=>'form-signin formlogin')); ?>
                  <div class="form-group">
                     <?php echo form_label(lang('Email Address'), 'email', array('class'=>'control-label')); ?>
                  ...
                  <div class="form-group">
                     <button type="submit" name="submit" class="btn btn-block btn-primary btn-lg"><?php echo lang('Activate Account'); ?></button>
                  </div>
                  <?php echo form_close(); ?>       
               </div>
            </div>
