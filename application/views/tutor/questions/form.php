          ...
          <div class="col-4">
            <div class="form-group">
              ...
              <input type="File" name="helpsheet" id="image" class="form-control">
                ...
                <?php if($question_data['helpsheet']) { ?>
          ...
          <div class="col-2">
            <div class="form-group">
              ...
              <select name="render_content" class="form-control">
                  <option value="0" <?php if($populateData==1) echo "selected" ?> ><?php echo lang('No'); ?></option>
                  <option value="1" <?php if($populateData==2) echo "selected" ?> ><?php echo lang('Yes'); ?></option> 
              </select>   
            </div>     
          </div>        
