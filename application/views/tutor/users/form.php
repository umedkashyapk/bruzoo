         ...
         <div class="card">
            <div class="card-body">
               ...
               <div class="row">
                  ...
                  <?php // administrator ?>
                  <div class="form-group col-sm-4<?php echo form_error('is_admin') ? ' has-error' : ''; ?>">
                     ...
                     $is_admin = (isset($user['is_admin']) && $user['is_admin'] == 1 ? 'Admin' :(isset($user['is_admin']) && $user['is_admin'] == 0 ? 'Visitor' : 'Authors'));
                     
                     echo form_dropdown('is_admin', $user_array, $is_admin, 'id="is_admin" class="form-control"'); 
                     ?>
                     <span class="small form-error"> <?php echo strip_tags(form_error('is_admin')); ?> </span>
                  </div>
                  ...
                  <div class="form-group col-sm-4<?php echo form_error('time_accommodation') ? ' has-error' : ''; ?>">
                     ...
                     <span class="required">*</span>
                     <?php 
                     $time_accommodation_array = array('NO'=>'NO','YES'=>'YES');
