...
<div class="panel panel-default">
      ...
      <a href="javascript:void(0)" hreff="<?php echo base_url('tutor/study/add-material-file/'.$study_material_id);?>" class="btn btn-primary cat float-right" data-toggle="modal" data-target="#s_m_contant_type" ><?php echo lang('admin_add_material_file'); ?></a>
   ...
   <hr>
                              ...
                              <div class=" col-12 section_box border rounded section_box mb-5" data-study_material_section_id="<?php echo $study_material_section_id; ?>">
                                    ...
                                    <div class="row bg-secondary rounded">
                                       ...
                                       <div class="col-2 m-auto">
                                          ...
                                          <a href="javascript:void(0)" class="m-auto btn btn-info update_studay_matrial_section" data-study_material_section_id="<?php echo $study_material_section_id; ?>" data-title="<?php echo $section_array->title; ?>" data-action="<?php echo base_url('tutor/study/section-update/'.$study_material_section_id);?>">
                                             <i class="fas fa-pencil-alt"></i>
                                          </a>

                                          <a href="<?php echo base_url('tutor/study/section-delete/'.$study_material_section_id); ?>" class="m-auto btn btn-danger study_material_section_delete" data-action="<?php echo base_url('tutor/study/section-delete/'.$study_material_section_id); ?>">
                                                ...
                                                <div class="col-12 contant_section border-bottom-1 py-2" data-s_m_section_contant_id="<?php echo $s_m_section_contant_id; ?>">
                                                   <div class="row">
                                                      ...
                                                      <div class="col-2  my-auto"> 
                                                         <a href="<?php echo base_url('tutor/study/update-material-content/'.$s_m_section_contant_id) ?>" class="m-auto btn btn-info" data-s_m_section_contant_id="<?php echo $s_m_section_contant_id; ?>"><i class="fas fa-pencil-alt"></i></a>

                                                         <a href="<?php echo base_url('tutor/study/delete-material-content/'.$s_m_section_contant_id); ?>" class="m-auto btn btn-danger study_material_section_contant_delete"><i class="fas fa-trash-alt"></i> </a>
                                                      </div>
                                                   </div>
      ...
      <div class="modal fade" id="section_modal" tabindex="-1" role="dialog" aria-labelledby="section_modal_view" aria-hidden="true">
         <div class="modal-dialog ">
            <div class="modal-content">
               <?php echo form_open_multipart(base_url('tutor/study/section/'.$study_material_id), array('role'=>'form','class'=> 'w-100')); ?>
               <div class="row">
                  <div class="col-12">
      ...
      <div class="modal fade" id="section_modal_update" tabindex="-1" role="dialog" aria-labelledby="section_modal_update_title" aria-hidden="true">
         <div class="modal-dialog ">
            <div class="modal-content"> 
               <?php echo form_open_multipart(base_url('tutor/study/section-update/1'), array('role'=>'form','class'=> 'form w-100')); ?>
               <div class="row">
                  <div class="col-12">
