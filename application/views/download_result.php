    ...
    <div class="modal-content">      
      ...
      <div class="modal-body">
        <div class="result-modal">
         <?php echo form_open_multipart(base_url('admin/ReportController/send_email/'.$participant_id), array('role'=>'form','novalidate'=>'novalidate')); ?>
            <div class="col-12">
            ...
            <div class="col-12">
              <?php echo  form_label(lang('send_type'), 'coupon_for'); ?><br/>
                ...
                <span><input type="radio" class="d-inline" checked="checked" name="attachment_type" value="1"></span><span>Attachment File</span>
             
              <span><input type="radio" class="d-inline" name="attachment_type" value="1"></span><span>Attachment link</span>
            </div>
